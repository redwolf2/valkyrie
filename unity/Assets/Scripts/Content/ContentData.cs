...
public class ContentData {
    ...
    public Dictionary<string, QuestData.VarDefinitionData> varDefinitions;
    ...
    public ContentData(string path)
    {
        ...
        // This has all avilable perils
        varDefinitions = new Dictionary<string, QuestData.VarDefinitionData>();
    ...
    void AddContent(string name, Dictionary<string, string> content, string path, string packID)
    {
        ...
        // Is this a "Var" entry?
        if (name.IndexOf(QuestData.VarDefinitionData.type) == 0)
        {
            var d = new QuestData.VarDefinitionData(name, content);
            // Ignore invalid entry
            if (d.sectionName.Equals(""))
                return;
            // If we don't already have one then add this
